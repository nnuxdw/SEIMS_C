...
from postprocess.plot_timeseries import get_upstream_subbasins,fetch_upstream_avg_series,plot_series,read_simulation_only,plot_sim_only
...
def main():
    ...
    basedir = r'G:\program\seims\SEIMS_HAND\data\TP_13\TP_13_longterm_model\OUTPUT0-0'
