...
def read_tif_as_array(tif_path, nodata_value=None, to_float=True):
    with rasterio.open(tif_path) as src:
        arr = src.read(1)  # band1
        nd = src.nodata if nodata_value is None else nodata_value
...
if __name__ == '__main__':
    ...
    # 木兰溪
    work_dir = r'G:\program\seims\SEIMS_HAND\data\MLX6'
    longter_model_name = 'MLX6_longterm_model'
