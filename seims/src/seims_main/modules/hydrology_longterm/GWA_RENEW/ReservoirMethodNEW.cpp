...
int ReservoirMethodNEW::Execute() {
    ...
    for (auto it = m_subbasinIDs.begin(); it != m_subbasinIDs.end(); ++it) {
       ...
       /*     if (!tiledrainSubarea[index].empty())
			...
			if (index == 15012) {
				float tmp_perc_last = m_soilPerco[index][last];      // ���²������ˮ��©��mm������ע����ǰ����ܻᱻ��д
				float revap_mm = m_revap[index];                     // ����ˮ�����ز���mm��
				float dGW_mm = tmp_perc_last - revap_mm;             // ��������ˮ�仯����mm��������ĸ��¹�ʽ��
        ...
        if (revap > m_gwSto[subID]) {
            for (int i = 0; i < curCellsNum; i++) {
                ...
                throw ModelException("ReservoirMethodNEW", "Execute", "��������");
            }
            revap = m_gwSto[subID];
        }
        ...
        for (int i = 0; i < curCellsNum; i++) {//��������Ӳ��У�Ҫ��Ȼ����һ��һ�����
            int index = curCells[i];
        ...
        if (isnan(groundStorage))
        {
			...
			cout.flush();
			throw ModelException("ReservoirMethodNEW", "EXECUTE", "����ˮΪnan");
        }
...
void ReservoirMethodNEW::SetScenario(Scenario* sce) {
    ...
    //            {
    //                throw ModelException("ReservoirMethodNEW", "SetScenario", "һ��subareaֻ�ܶ�Ӧһ��tiledrain");
    //            }
    //        }
    //    }
    /*}*/
