...
static int opterror(struct optparse *options, const char *message,
	const char *data)
{
	unsigned        p = 0;
	while (*message)
...
static inline int is_dashdash(const char *arg)
{
	return arg != 0 && arg[0] == '-' && arg[1] == '-' && arg[2] == '\0';
}

static inline int is_shortopt(const char *arg)
{
	return arg != 0 && arg[0] == '-' && arg[1] != '-' && arg[1] != '\0';
}

static inline int is_longopt(const char *arg)
{
	return arg != 0 && arg[0] == '-' && arg[1] == '-' && arg[2] != '\0';
}
...
static inline int longopts_end(const struct optparse_long *longopts, int i)
{
