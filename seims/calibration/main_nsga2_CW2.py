...
#######
    ...
    multiobj.setdefault('F_19', [['NSE', 1., -100, '>0']])
...
if os.name == 'nt':  # Windows
    ...
    base_path = r'G:\program\seims\SEIMS_C\data\CW_2'
else:  # Linux/Unix
    base_path = '/data/user/xiaodw/software/SEIMS_C/data/CW_2'
# # 淹没范围才会用，淹没面积率定不用管
